...
from pumch_asr.utils.vocab import build_vocab_from_texts, load_texts_from_kaldi_text, save_vocab


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a CTC char vocabulary from Kaldi text")
